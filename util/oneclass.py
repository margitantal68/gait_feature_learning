...
from util.settings import AGGREGATE_BLOCK_NUM, TEMP_NAME


def evaluate_authentication( df, verbose = False, roc_data = False, roc_data_filename = TEMP_NAME):
    print(df.shape)
    ...
    # ****************************************************************************************
    # plot_scores(global_positive_scores, global_negative_scores, filename='scores.png', title='End-to-end - session1')
    # ****************************************************************************************
...
def evaluate_authentication_cross_day( df1, df2, verbose = False, roc_data = False, roc_data_filename = TEMP_NAME ):
